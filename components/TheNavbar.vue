    ...
    <div class="flex items-center justify-between">
      ...
      <div class="hidden lg:block">
        <ul
          ...
          <div class="flex justify-items-center">
            <NuxtLink to="/clubs" class="hover:font-bold pb-2"> School Clubs
            </NuxtLink>
            <div v-if="isOpen">
          ...
          <div class="flex justify-items-center">
            <NuxtLink to="/camps" class="hover:font-bold pb-2"> Activity Camps
            </NuxtLink>
            <div v-if="isOpen">
              <font-awesome-icon :icon="['fas', 'angle-up']"
                                 class="text-secondary h-8 w-8 my-auto" />
          ...
          <div class="flex justify-items-center">
            <NuxtLink to="/parties" class="hover:font-bold pb-2"> Kids Parties
            </NuxtLink>
            <div v-if="isOpen">
              <font-awesome-icon :icon="['fas', 'angle-up']"
                                 class="text-secondary h-8 w-8 my-auto" />
          ...
          <div class="flex items-center">
            <NuxtLink to="/contact" class="hover:font-bold pb-2"> Contact
            </NuxtLink>
          </div>
        </ul>
      </div>
      ...
      <transition enter-class="opacity-0"
        ...
        <div @keydown.esc="isOpen = false" v-show="isOpen"
          ...
          <div @click="isOpen = false"
               class="absolute inset-0 bg-black opacity-50" tabindex="0"></div>
        </div>
      </transition>
      <!-- Drawer Menu -->
      <aside class="p-5 transform top-0 right-0 left-0 w-80 bg-accent fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30"
        ...
        <ul
          ...
          <div class="flex items-center">
            <NuxtLink to="/clubs" @click="isOpen = false"
          ...
          <div class="flex items-center">
            <NuxtLink to="/camps" @click="isOpen = false"
                      class="my-4 inline-block">
          ...
          <div class="flex items-center">
            <NuxtLink to="/parties" @click="isOpen = false"
                      class="my-4 inline-block">
        ...
        <div class="follow">
          <p class="font-mulish uppercase text-secondary text-2xl">follow us:
          </p>
