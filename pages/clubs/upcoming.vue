  ...
  <div class="my-8">
    <div class="max-w-7xl mx-auto">
      <div class="px-8 md:container py-4">
        ...
        <p>School strike days are beyond our control and therefore are not refundable. However, any days that AbsoluteSport cancels due to unforseen circumstances will be refunded.</p>
        <p>Please select a school badge to view the currently available clubs for your child's school including information about any planned strike days or inset days.</p>
        ...
        <div v-if="selectedImage" class="my-8">
          ...
          <div v-else>
            <p>We are sorry for any inconveniece caused but we don't have any current clubs to display for your selected school. This could be due to various reasons such as school holidays, a change in the school programme or they are booked to capacity.</p>
          </div>
        </div>
      </div>
    </div>
