  ...
  <div class="max-w-7xl mx-auto print:bg-light print:text-dark">
    <div class="container py-8">
      ...
      <p class="tracking-wide text-dark">
        Thank you for reserving your child a place in our clubs. Please use the
        payment reference for any future correspondence.
      </p>
      <p>Payment is by bank transfer to:</p>
      <p>Account Name:</p>
      <p>Account Number:</p>
      <p>Sort Code:</p>
      <p>Beneficiary Reference: {{ data.paymentRef }}</p>
      <div class="pb-4">
