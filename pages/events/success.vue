...
useHead({
  title: `Family Fun Day ticket reservation success`,
  meta: [
    {
      name: "robots",
      content: "noindex",
  ...
  link: [
    {
      rel: "canonical",
      href: "https://www.absolutesport.org/events/success",
    },
  ],
});
...
const payNow = async () => {
  const details = {
    ...
    amount: amount,
    description: `AbsoluteSport Family Fun Day Charity Event : bookings payment: ${paymentRef.value}`,
  };
  ...
  <div class="max-w-7xl mx-auto print:bg-light print:text-dark">
    <div class="container py-8">
      ...
      <p class="font-inter-medium print:hidden">
        ...
        PDF for future reference before closing the page.
      </p>
      <button
      ...
      <div v-if="instantPayment" class="print:hidden">
        ...
        <p>
          This option confirms your tickets immediately and is the recommended
          payment method.
        </p>
        <p>
          Click <span class="font-play">Request Pay Now </span>to create an
        ...
        <p>
          Click <span class="font-play"> Pay Now </span> to be securely
          redirected to our payment processor
          <span class="font-play"> GoCardless</span>. Your bank will ask you to
          authorise the payment.
        </p>
        <p>
          As soon your payment has been processed, you will receive a
          confirmation email for your records from<span class="font-play">
            GoCardless</span
          >.
        </p>
        ...
        <p>
          ...
          banking you can still pay via bank transfer.
        </p>
      </div>
      <h3 v-else>Please pay by bank transfer</h3>
      <p>
        Please ensure you use the payment reference provided and email us the
        bank payment confirmation.
      </p>
      <p class="font-inter-bold">
        Your booking status will be updated to paid on receipt of the funds in
        our account.
      </p>
      ...
      <div class="pb-4">
        ...
        <p>
          ...
          any correspondence relating to this booking.
        </p>
        <div>
