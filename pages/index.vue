...
<template>
  <section
    class="bg-blend-overlay bg-neutral-600 bg-[url('/img/hero_1920.webp')] bg-center bg-no-repeat bg-cover w-full h-[90vh] md:h-[70vh] pt-10 pb-4"
  >
    ...
    <div class="container">
      <BaseCard>
        <BaseContent>
          ...
          <template #para-2
            >After School Clubs give the children that opportunity to learn a new sport or
            enhance their current skills in their favourite sports. We do a wide range of
  ...
  <!-- About -->
  <section
    class="bg-blend-overlay bg-neutral-700 bg-[url('/img/home_about_1920.webp')] lg:bg-center sm:bg-left bg-no-repeat bg-cover w-full h-[90vh] py-10"
  >
    <div class="max-w-6xl mx-auto">
      <div class="container">
        <BaseContent>
