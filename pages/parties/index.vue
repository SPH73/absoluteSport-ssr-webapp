...
let party = {};
console.log("party details content", content.value);
      ...
      <div class="container py-4">
        ...
        <div>
          <p>
            ...
            coaches all ensure that the children attending the party will have
            an absolute blast of a time. We aim to keep all parties stress free
            by tailoring the entire process around you and your child's needs.
            If you have something more specific in mind than what you see listed
            here on the site, please do contact us and we will be more than
            happy to help assist in creating the ideal party for your child.
          </p>
        </div>
      </div>
    </section>
