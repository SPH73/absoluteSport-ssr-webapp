...
export default defineNuxtPlugin((nuxtApp) => {
  library.add(faBars, faXmark, faFacebook, faInstagram, faLinkedin, faMedal, faHeartPulse, faPersonRunning, faRankingStar, faFutbolBall, faFutbol, faFlagCheckered, faAward, faHouseChimney, faStar, faPen, faPrint, faThumbsUp, faShop, faUsers, faHandHoldingHeart, faMountainSun, faMapLocationDot, faCalendarDays, faCalendarTimes, faCalendarWeek, faComment, faAngleDown, faAngleUp, faAngleRight, faAngleLeft, faCheck, faAddressCard, faUser, faArrowRight, faArrowLeft, faEnvelope, faQuestion, faImage, faFaceSmileBeam, faBolt, faArtstation, faLightbulb, faMagnifyingGlassArrowRight, faSuperpowers, faSurprise )
